 ...
 * @since 
 */  
public class TcpClientTest extends IoHandlerAdapter {  
    private IoConnector connector;  
    private static IoSession session;  
    public TcpClientTest() {  
        connector = new NioSocketConnector();  
        connector.setHandler(this);  
        ConnectFuture connFuture = connector.connect(new InetSocketAddress("localhost", 9108));  
    ...
    public void messageReceived(IoSession iosession, Object message)  
        ...
        System.out.println("客户端收到消息" + StringUtils.bytes2HexString(byten));  
    }
