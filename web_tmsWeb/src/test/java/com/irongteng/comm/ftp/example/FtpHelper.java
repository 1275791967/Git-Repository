...
public class FtpHelper {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FtpHelper fu = new FtpHelper("192.168.1.44", 21, "admin","123456");
            fu.connectFTPServer();
            /*
            ...
            */
            ...
            //fu.createFold("/test");
            File file = new File("c:\\jconsole.jar");
            
            fu.uploadFile("c:\\syslog.txt", "syslog.txt", "/");
            ;
            System.out.println(fu.changeDirectory("/"));
            //fu.downloadFile("/","jconsole.jar", "d:\\");
            //fu.deleteFtpServerFile("/jconsole.jar");
        } catch (Exception e) {
