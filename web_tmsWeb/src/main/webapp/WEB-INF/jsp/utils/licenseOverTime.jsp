...
.loginForm p { float:left; display:block; width:580px; height:21px; margin:0; padding:5px 0; position:relative;}
.loginForm label { float:left; width:120px; padding:0 5px; line-height:21px;}
-->
</style>

<div class="loginForm">
    <h2 style="color:red;">该系统授权已经过期</h2>
    <p>你好，你所使用的软件授权已经过期，你将无法登录该系统，也无法使用该系统提供的功能</p>
    <p>你需要联系开发商重新获取授权才能使用</p>
</div>