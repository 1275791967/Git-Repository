...
<form method="post" action="<c:url value='/management/opInfo/insert?navTabId=OpInfoLiNav&callbackType=closeCurrent'/>" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
    <div class="pageFormContent" layoutH="57">
<%--     <input type="hidden" name="id" value="${bean.id}"/>   --%>
        <dl>
            <dt>运营商编号: </dt>
            <dd>
                <input type="text" name="opNo" value="${bean.opNo}" class="required" minlength="1" maxlength="20"/>
            </dd>
        </dl> 
        <dl>
            <dt>运营商名称: </dt>
