...
<div class="pageContent">
    <form method="post" action="<c:url value='/management/device/importExcel?navTabId=deviceListNav&callbackType=closeCurrent'/>" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);">
...
<div class="pageContent" style="margin: 0 10px" layoutH="20">
     
    <input id="importExcelFile" type="file" name="importExcelFile" 
        uploaderOption="{
            swf:'styles/uploadify/scripts/uploadify.swf',
            uploader:'<c:url value='/management/device/importExcel;jsessionid=${pageContext.session.id}'/>',
    ...
    <input type="image" src="styles/uploadify/img/upload.jpg" onclick="$('#importExcelFile').uploadify('upload', '*');"/>
    <input type="image" src="styles/uploadify/img/cancel.jpg" onclick="$('#importExcelFile').uploadify('cancel', '*');"/>
