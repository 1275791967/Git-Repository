...
<form method="post" action="<c:url value='/management/customer/insert?navTabId=CustomerLiNav&callbackType=closeCurrent'/>" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
    <div class="pageFormContent" layoutH="57">
        <dl>
            <dt>客户名: </dt>
            <dd>
                <input type="text" name="CustomerName" value="${bean.customerName}" class="required" minlength="1" maxlength="20"/>
            </dd>
        </dl>
        <dl>
            <dt>联系方式: </dt>
            <dd>
                <input type="text" name="contact" value="${bean.contact}" class="required digits" minlength="2" maxlength="20"/>
            </dd>
        </dl>
        <dl>
            <dt>地址: </dt>
