...
<div class="pageContent">
    <form method="post" action="<c:url value='/management/device/importExcel?navTabId=DeviceLiNav&callbackType=closeCurrent'/>" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);">
