...
<div class="pageContent">
    <form method="post" action="<c:url value='/management/imsi_phone/importExcel?navTabId=IMSI_PhoneLiNav&callbackType=closeCurrent'/>" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);">
