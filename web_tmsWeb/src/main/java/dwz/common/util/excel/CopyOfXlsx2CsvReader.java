 ...
 * @author 山人 
 */  
public class CopyOfXlsx2CsvReader {  
     ...
     */  
    public CopyOfXlsx2CsvReader(OPCPackage pkg, PrintStream output, String sheetName, int minColumns) {  
    ...
    public static List<String[]> readerExcel(String path, String sheetName, int minColumns) throws IOException, OpenXML4JException, ParserConfigurationException, SAXException {  
        OPCPackage opcp = OPCPackage.open(path, PackageAccess.READ);  
        CopyOfXlsx2CsvReader xlsx2csv = new CopyOfXlsx2CsvReader(opcp, System.out, sheetName, minColumns);  
    ...
    public static void main(String[] args) throws Exception {  
        List<String[]> list = CopyOfXlsx2CsvReader.readerExcel( "d://test.xlsx", "test", 17);  
