...
import com.irongteng.conf.ConfigConstants;
...
public class AppConfiguration {
    ...
    private Map<String, Template> webTemplateMap = null;
    ...
    public static synchronized void init(String configFile)
        ...
        if (appConf == null) {
            ...
            appConf.conf = new DefaultConfigurationBuilder(configFile).getConfiguration();
            ...
            appConf.fetchTimerTask(basePath);   //启动定时任务
            appConf.fetchMailTemplateSetting(); //启动邮件相关设置
            appConf.fetchWebsiteTemplate();     //启用对应的web模板
        }
    }
    
    public static synchronized void init() throws ConfigurationException {
        
        init(AppConfiguration.class.getResource("/").getPath() + ConfigConstants.APP_CONFIF);
    }
    ...
    private void fetchWebsiteTemplate() {
        ...
        for (String templateName : templateNames) {
            ...
            for (String layoutName : layoutNames) {
                ...
                System.out.println("layoutName: " + templateName + " -> " + layoutName);
