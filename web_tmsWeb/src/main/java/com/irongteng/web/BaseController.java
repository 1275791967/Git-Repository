...
import com.irongteng.web.editor.DateEditor;
import com.irongteng.web.editor.DoubleEditor;
import com.irongteng.web.editor.IntegerEditor;
import com.irongteng.web.editor.LongEditor;
import com.irongteng.web.editor.StringEditor;
...
//    protected SpringContextHolder _contextHolder;
    ...
    protected boolean verifyValidationCode(String validationCode) {
        ...
        if (enableVerify) {
            ...
            try {
                randomCode = (String) request.getSession().getAttribute(Constants.VALIDATION_CODE);
