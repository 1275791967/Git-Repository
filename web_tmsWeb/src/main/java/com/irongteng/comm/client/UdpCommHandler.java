 ...
 */
public class UdpCommHandler extends IoHandlerAdapter {
    
    private Logger logger = LoggerFactory.getLogger(UdpCommHandler.class);
    /**
     * 发送数据
     * @param session
     * @param message
    ...
    public void messageReceived(IoSession session, Object message) throws Exception {
        ...
        if (message instanceof IoBuffer) {
            ...
            if (!parseResult) {
                ...
                param.setCommCategory(CommContants.UDP);
