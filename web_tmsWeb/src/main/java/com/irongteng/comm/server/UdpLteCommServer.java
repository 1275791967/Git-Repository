...
public class UdpLteCommServer extends CommServer {
    ...
    public UdpLteCommServer(int port)  {
        this.port = port;
    }
    ...
    public void start() {
        ...
        try {
            ...
            CommHandler commHandler = new CommHandler(CommModeStatus.UDP_LTE);
